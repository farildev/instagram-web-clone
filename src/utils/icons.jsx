const HomeFilledIcon = ({size}) => {
    return (
        <svg aria-label="Home" className="_ab6-" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height={size} role="img" viewBox="0 0 24 24" width={size}><path d="M22 23h-6.001a1 1 0 0 1-1-1v-5.455a2.997 2.997 0 1 0-5.993 0V22a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V11.543a1.002 1.002 0 0 1 .31-.724l10-9.543a1.001 1.001 0 0 1 1.38 0l10 9.543a1.002 1.002 0 0 1 .31.724V22a1 1 0 0 1-1 1Z"/>
        </svg>
...
const HomeIcon = ({size}) => {
    return (
        <svg aria-label="Home" className="_ab6-" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height={size} role="img" viewBox="0 0 24 24" width={size}>
...
const SearchIcon = ({size}) => {
    return (
        <svg aria-label="Search" className="_ab6-" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height={size} role="img" viewBox="0 0 24 24" width={size}>
...
const ExploreIcon = ({size}) => {
    return (
        <svg aria-label="Explore" className="_ab6-" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height={size} role="img" viewBox="0 0 24 24" width={size}>
...
const ReelIcon = ({size}) => {
    return (
        <svg aria-label="Reels" className="_ab6-" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height={size} role="img" viewBox="0 0 24 24" width={size}>
...
const MessageIcon = ({size}) => {
    return (
        <svg aria-label="Messenger" className="_ab6-" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height={size} role="img" viewBox="0 0 24 24" width={size}>
...
const HeartIcon = ({size}) => {
    return (
        <svg aria-label="Notifications" className="x1lliihq x1n2onr6" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height={size} role="img" viewBox="0 0 24 24" width={size}>
...
const CreateIcon = ({size}) => {
    return (
        <svg aria-label="New post" className="_ab6-" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height={size} role="img" viewBox="0 0 24 24" width={size}>
...
const ProfileIcon = ({size}) => {
    return (
        <svg stroke="currentColor" fill="none" strokeWidth="0" viewBox="0 0 24 24" height={size} width={size} xmlns="http://www.w3.org/2000/svg">
...
const HamburgerIcon = ({size}) => {
    return (
        <svg aria-label="Settings" className="_ab6-" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height={size} role="img" viewBox="0 0 24 24" width={size}>
...
const SettingsIcon = ({size}) => {
    return (
        <svg aria-label="Settings" className="x1lliihq x1n2onr6" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height={size} role="img" viewBox="0 0 24 24" width={size}>
...
const ActivityIcon = ({size}) => {
    return (
        <svg aria-label="Your Activity" className="x1lliihq x1n2onr6" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height={size} role="img" viewBox="0 0 24 24" width={size}>
            <path d="M12 1.505a10.5 10.5 0 1 1-7.424 17.924" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"/>
            <polyline fill="none" points="8.893 15.108 12 12 12.012 12.012 12.012 5.793" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"/>
            <circle cx="7.24" cy="2.651" r="1.125"/>
            <circle cx="3.515" cy="5.83" r="1.125"/>
            <circle cx="1.636" cy="10.353" r="1.125"/>
            <circle cx="2.01" cy="15.235" r="1.125"/>
        </svg>
    )
}
const SavedIcon = ({size}) => {
    return (
        <svg aria-label="Saved" className="x1lliihq x1n2onr6" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height={size} role="img" viewBox="0 0 24 24" width={size}>
...
const ThemeIcon = ({size}) => {
    return (
        <svg aria-label="Theme icon" className="x1lliihq x1n2onr6" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height={size} role="img" viewBox="0 0 24 24" width={size}>
...
const ReportIcon = ({size}) => {
    return (
        <svg aria-label="Report a problem" className="x1lliihq x1n2onr6" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height={size} role="img" viewBox="0 0 24 24" width={size}>
...
const VerifiedIcon = ({size}) => {
    return (
        <svg aria-label="Verified" className="x1lliihq x1n2onr6" color="rgb(0, 149, 246)" fill="rgb(0, 149, 246)" height={size} role="img" viewBox="0 0 40 40" width={size}>
...
const CreateAreaIcon = ({size}) => {
    return (
        <svg aria-label="Icon to represent media such as images or videos" class="x1lliihq x1n2onr6" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height={size} role="img" viewBox="0 0 97.6 77.3" width={size}>
